...
@Component({
  ...
  template: `
    <div class="text-black dark:text-white">
      <h1></h1>
      <div class="bg-gray-200 text-slate-700 dark:text-slate-100 dark:bg-slate-800 rounded px-4 py-2">
      ...
      <a
        class="text-slate-700 dark:text-slate-100 text-xs float-right underline underline-offset-1 mt-2"
