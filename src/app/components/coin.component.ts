...
@Component({
  selector: 'ac-coin',
  template: `
    <div class="flex justify-center items-center text-black dark:text-white text-base md:text-xl bg-gray-200 dark:bg-slate-800 rounded w-full mx-auto mt-8 py-2">
